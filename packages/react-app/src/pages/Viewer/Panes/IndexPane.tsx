        ...
        <Box overflowY={"auto"} flexGrow={1} h={"full"}>
          <Box maxHeight={"550px"}>
            ...
            <Grid templateColumns={"0.1fr 1fr"} mt={2}>
              ...
              <GridItem>
                <Typography variant={TVariant.ComicSans16} block>
                  Burn Doge Pixels to redeem their fair value in DOG.
                </Typography>
              </GridItem>
            </Grid>
            ...
            <Box mt={8}>
              <Typography mb={4} variant={TVariant.PresStart18} block>
                Have a legacy pixel?
              </Typography>
              <Typography variant={TVariant.ComicSans16} block>
                Visit the legacy portal on ETH mainnet to view or burn your legacy Pixels.
                <br />
                Legacy pixels will always be applicable for Pixel Perks and the burning function will be permanently
                available.
              </Typography>
              <Box mt={6} mb={6} className="flex flex-col">
                <a href="https://legacy.pixels.ownthedoge.com">
                  <Button size="sm" mr={8}>
                    Go to Legacy Portal
                  </Button>
                </a>
